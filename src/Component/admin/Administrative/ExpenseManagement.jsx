...
        ["Date", new Date(parseInt(expense.ExpenseDate)).toLocaleDateString()],
        ["Category", expense.Category.CategoryName],
...
          <div className="bg-white rounded-lg p-6 max-w-lg w-full"> {/* Reduced max-w for mobile */}
...
   पाठonChange={(e) => setFormData({ ...formData, receiptUrl: e.target.value })}
                />
...
              <div className="flex justify-end space-x-2 mt-4"> {/* Added mt-4 for better spacing */}
                <button
                  type="button"
...
      <div className="overflow-x-auto w-full"> {/* Added w-full for table responsiveness */}
...
                <td className="text-right font-bold"> {/* Made amount text bold for emphasis */}

...
<h1 className='w-full h-10 font-serif text-2xl text-black bg-yellow-300 flex justify-center items-center'>
  Currently Under Maintenance
</h1>  <h2 className="text-2xl font-bold mb-4">Timetable Management</h2>
